...
var normPoint = $(".navbar-nav > li > a").css('font-size');
console.log(normPoint);
var docWidth = 0;
        ...
        $(".carousel").css({"height":"0%"});
                ...
                setTimeout(function(){
                    $(".carousel").css({"visibility":"visible"});
                           ...
                           $("header~.container-fluid").css({"top":"300px"});
        ...
        var currDocWidth = $(this).width();
                 ...
                 if(currDocWidth/1280 < .9){
                   ...
                   $(".navbar-collapse.collapse").css({"width":docWidth});
                    ...
                    $(".navbar-collapse.collapse").css({"width":"100%"});
                 $(".navbar-nav > li > a, .navbar-nav > li > span").css({"font-size":normPoint});
                 }
                 if( currDocWidth < docWidth ){
                 $(".navbar-collapse.collapse").css({"margin-right": currDocWidth += 20});
                 
                 }
                 docWidth = currDocWidth;
                });
...
$(window).scroll(function(){
        ...
        if ($(window).scrollTop() > 400){
            ...
            $(".navbar-inverse").css({"background":"transparent"});
                  $(".navbar").removeClass(".collapsed-nav");
        }
            });
